...
package com.esotericsoftware.spine.include.utils.reflect;
...
public final class ClassReflection {
	...
	static public boolean isAnnotationPresent (Class c, Class<? extends Annotation> annotationType) {
	...
	static public Annotation getAnnotation (Class c, Class<? extends Annotation> annotationType) {
	...
	/** Returns an {@link Annotation} object reflecting the annotation provided, or null if this class doesn't have such an
	 * annotation. This is a convenience function if the caller knows already which annotation type he's looking for. */
	static public Annotation getDeclaredAnnotation (Class c, Class<? extends Annotation> annotationType) {
		java.lang.annotation.Annotation[] annotations = c.getDeclaredAnnotations();
